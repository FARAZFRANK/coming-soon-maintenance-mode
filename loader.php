...
$dynamic_css .= ".home-content__subscribe, #mc-form, .subscribe-form, .home-content__form { max-width: 540px !important; width: 100% !important; height: 54px !important; min-height: 54px !important; max-height: 54px !important; margin-left: 0 !important; margin-right: auto !important; position: relative !important; }\n";
$dynamic_css .= ".text-center .home-content__subscribe, .text-center #mc-form, .text-center .subscribe-form, .text-center .home-content__form, .home-content.text-center .home-content__subscribe, .home-content__main.text-center .home-content__subscribe, .home-content__text.text-center .home-content__subscribe, [class*=\"text-center\"] .home-content__subscribe, [class*=\"text-center\"] #mc-form { margin-left: auto !important; margin-right: auto !important; }\n";
...
if ( 'solid' === $csmm_bg_type ) {
	...
	$pattern_css_map = array(
		...
		'waves'          => "background-color: #081226 !important; background-image: url('{$svg_waves}') !important; background-size: 80px 40px !important; background-repeat: repeat !important;",
		...
		'sakura'         => "background-color: #1a0b18 !important; background-image: url('{$svg_sakura}') !important; background-size: 100px 100px !important; background-repeat: repeat !important;",
		'custom_pattern' => '',
	);
