...
if ( 'solid' === $csmm_bg_type ) {
	...
	$dynamic_css .= "body, html, .s-home, main.s-home, section.s-home, #home, .template-one, .template-two, .prospectus-card, .main-card, .split-layout, #particles-js, .home-particles, #bg, .bg-image, .bg-container { {$pat_rule} }\n";
