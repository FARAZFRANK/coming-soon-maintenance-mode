...
if ( 'vimeo' === $csmm_bg_video_source ) {
	$v_cand = ! empty( $csmm_bg_video_vimeo_url ) ? $csmm_bg_video_vimeo_url : ( isset( $csmm_content['bg_video_url'] ) ? $csmm_content['bg_video_url'] : '' );
	$csmm_bg_video_url = ( ! empty( $v_cand ) && false !== strpos( $v_cand, 'vimeo' ) ) ? $v_cand : 'https://vimeo.com/1178283333';
} elseif ( 'file' === $csmm_bg_video_source || 'mp4' === $csmm_bg_video_source ) {
	$mp4_cand = ! empty( $csmm_bg_video_mp4_url ) ? $csmm_bg_video_mp4_url : ( isset( $csmm_content['bg_video_url'] ) ? $csmm_content['bg_video_url'] : '' );
...
// Template 17 specific overrides to guarantee Screenshot 1 layout and styling
$dynamic_css .= ".prospectus-card { max-width: 880px !important; width: 100% !important; min-height: 480px !important; max-height: 530px !important; height: 500px !important; margin: auto !important; display: grid !important; grid-template-columns: 1.15fr 0.85fr !important; background-color: #FFFFFF !important; border-radius: 12px !important; overflow: hidden !important; box-shadow: 0 20px 45px -10px rgba(0, 0, 0, 0.25) !important; position: relative !important; z-index: 2 !important; }\n";
...
$dynamic_css .= ".prospectus-content #subscribe-form { height: 42px !important; min-height: 42px !important; max-height: 42px !important; max-width: 380px !important; margin: 0 !important; }\n";
$dynamic_css .= ".prospectus-content #subscribe-form .subscribe-input { background: #F7FAFC !important; border: 1px solid #E2E8F0 !important; border-right: none !important; color: #2D3748 !important; border-radius: 4px 0 0 4px !important; height: 42px !important; min-height: 42px !important; max-height: 42px !important; line-height: 42px !important; padding: 0 14px !important; font-size: 13px !important; }\n";
$dynamic_css .= ".prospectus-content #subscribe-form .subscribe-btn { background: #1A202C !important; background-color: #1A202C !important; color: #FFFFFF !important; border: 1px solid #1A202C !important; border-radius: 0 4px 4px 0 !important; height: 42px !important; min-height: 42px !important; max-height: 42px !important; line-height: 42px !important; padding: 0 18px !important; font-size: 12px !important; font-weight: 600 !important; }\n";
