...
$csmm_bg_custom_pattern_bg   = isset( $csmm_content['bg_custom_pattern_bg'] ) ? $csmm_content['bg_custom_pattern_bg'] : '#0b1120';
...
$dynamic_css .= ".home-content__subscribe, #mc-form, .subscribe-form, .home-content__form { max-width: 540px !important; width: 100% !important; height: 54px !important; min-height: 54px !important; max-height: 54px !important; margin-top: 20px !important; margin-bottom: 28px !important; position: relative !important; }\n";
...
$dynamic_css .= ".home-logo .home-social, .home-content .home-social, .home-content__main .home-social, section .home-social { left: 0 !important; right: 0 !important; margin-left: auto !important; margin-right: auto !important; padding: 0 !important; display: flex !important; justify-content: center !important; align-items: center !important; width: 100% !important; list-style: none !important; }\n";
...
$dynamic_css .= ".template-12 .home-logo { display: flex !important; justify-content: space-between !important; align-items: center !important; width: 100% !important; }\n";
$dynamic_css .= ".template-12 .home-logo .home-social, .template-12 .home-social { width: auto !important; margin: 0 0 0 auto !important; left: auto !important; right: 0 !important; justify-content: flex-end !important; }\n";
$dynamic_css .= ".prospectus-content .home-social { margin-left: 0 !important; margin-right: auto !important; justify-content: flex-start !important; width: auto !important; }\n";
$dynamic_css .= ".main-card #subscribe-form, .main-content #subscribe-form, .prospectus-content #subscribe-form, .content-side #subscribe-form { position: relative !important; max-width: 520px !important; height: 50px !important; min-height: 50px !important; max-height: 50px !important; display: flex !important; flex-direction: row !important; align-items: center !important; gap: 12px !important; }\n";
$dynamic_css .= ".main-card #subscribe-form input[type=\"email\"], .main-content #subscribe-form input[type=\"email\"], .prospectus-content #subscribe-form input[type=\"email\"], .content-side #subscribe-form input[type=\"email\"] { padding-right: 16px !important; padding-left: 16px !important; width: auto !important; flex: 1 1 auto !important; height: 50px !important; min-height: 50px !important; max-height: 50px !important; line-height: 50px !important; margin: 0 !important; }\n";
$dynamic_css .= ".main-card #subscribe-form button, .main-content #subscribe-form button, .prospectus-content #subscribe-form button, .content-side #subscribe-form button { position: static !important; height: 50px !important; min-height: 50px !important; max-height: 50px !important; line-height: 1 !important; margin: 0 !important; padding-top: 0 !important; padding-bottom: 0 !important; white-space: nowrap !important; display: inline-flex !important; align-items: center !important; justify-content: center !important; }\n";
$dynamic_css .= ".main-card #subscribe-form input[type=\"email\"], .main-card #subscribe-form input#csmm-email, .main-card .subscribe-input, .main-card #subscribe-form button, .main-card .subscribe-btn { border-radius: 9999px !important; }\n";
...
if ( 'solid' === $csmm_bg_type ) {
	...
	$pattern_css_map = array(
		...
		'dots'           => "background-color: #0b1120 !important; background-image: radial-gradient(rgba(59, 130, 246, 0.6) 2px, transparent 2px) !important; background-size: 24px 24px !important; background-repeat: repeat !important;",
		...
		'carbon'         => "background-color: #0f1117 !important; background-image: linear-gradient(27deg, #151821 5px, transparent 5px), linear-gradient(207deg, #151821 5px, transparent 5px), linear-gradient(27deg, #1e2230 5px, transparent 5px), linear-gradient(207deg, #1e2230 5px, transparent 5px), linear-gradient(90deg, #181c27 10px, transparent 10px), linear-gradient(#1b1e2b 25%, #141722 25%, #141722 50%, transparent 50%, transparent 75%, #232838 75%, #232838) !important; background-size: 20px 20px !important; background-repeat: repeat !important;",
		'lines'          => "background-color: #0b1120 !important; background-image: repeating-linear-gradient(45deg, rgba(59, 130, 246, 0.25), rgba(59, 130, 246, 0.25) 2px, transparent 2px, transparent 16px) !important; background-size: auto !important; background-repeat: repeat !important;",
		'diagonal'       => "background-color: #0b1120 !important; background-image: repeating-linear-gradient(45deg, rgba(59, 130, 246, 0.25), rgba(59, 130, 246, 0.25) 2px, transparent 2px, transparent 16px) !important; background-size: auto !important; background-repeat: repeat !important;",
		'stars'          => "background-color: #030712 !important; background-image: radial-gradient(2px 2px at 20px 30px, #ffffff, rgba(0,0,0,0)), radial-gradient(2px 2px at 40px 70px, rgba(255,255,255,0.9), rgba(0,0,0,0)), radial-gradient(1px 1px at 90px 40px, #ffffff, rgba(0,0,0,0)), radial-gradient(2px 2px at 160px 120px, rgba(147,197,253,0.9), rgba(0,0,0,0)), radial-gradient(1.5px 1.5px at 230px 190px, #ffffff, rgba(0,0,0,0)) !important; background-size: 250px 250px !important; background-repeat: repeat !important;",
		'custom_pattern' => '',
	);

	if ( 'custom_pattern' === $csmm_bg_pattern || 'custom' === $csmm_bg_pattern ) {
		$custom_pat_url  = ! empty( $csmm_bg_custom_pattern_url ) ? esc_url( $csmm_bg_custom_pattern_url ) : '';
		$custom_pat_size = ! empty( $csmm_bg_custom_pattern_size ) ? intval( $csmm_bg_custom_pattern_size ) . 'px' : '60px';
		$custom_pat_rep  = ! empty( $csmm_bg_custom_pattern_repeat ) ? esc_attr( $csmm_bg_custom_pattern_repeat ) : 'repeat';
		$custom_pat_bg   = ! empty( $csmm_bg_custom_pattern_bg ) ? esc_attr( $csmm_bg_custom_pattern_bg ) : '#0b1120';
		if ( ! empty( $custom_pat_url ) ) {
			$pat_rule = "background-color: {$custom_pat_bg} !important; background-image: url('{$custom_pat_url}') !important; background-size: {$custom_pat_size} !important; background-repeat: {$custom_pat_rep} !important;";
		} else {
