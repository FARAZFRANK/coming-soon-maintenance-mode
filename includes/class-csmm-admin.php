...
class CSMM_Admin {
	...
	public function render_admin_app() {
		?>
		<div id="csmm-react-root" style="margin-left: -20px; padding: 0; min-height: calc(100vh - 60px); display: flex; align-items: center; justify-content: center; background: #f8fafc;">
