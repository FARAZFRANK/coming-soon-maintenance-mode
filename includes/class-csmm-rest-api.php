	...
	public function save_settings( $request ) {
		...
		if ( isset( $params['integrations'] ) && is_array( $params['integrations'] ) ) {
			...
			$int_array = array(
				...
				'email_bg_color'         => isset( $int_input['email_bg_color'] ) ? sanitize_hex_color( $int_input['email_bg_color'] ) : '#f8fafc',
				'email_card_bg'          => isset( $int_input['email_card_bg'] ) ? sanitize_hex_color( $int_input['email_card_bg'] ) : '#ffffff',
				'email_text_color'       => isset( $int_input['email_text_color'] ) ? sanitize_hex_color( $int_input['email_text_color'] ) : '#1e293b',
				'email_footer_text'      => isset( $int_input['email_footer_text'] ) ? sanitize_text_field( $int_input['email_footer_text'] ) : '',
				'email_footer_bg'        => isset( $int_input['email_footer_bg'] ) ? sanitize_hex_color( $int_input['email_footer_bg'] ) : '#f1f5f9',
				'email_footer_color'     => isset( $int_input['email_footer_color'] ) ? sanitize_hex_color( $int_input['email_footer_color'] ) : '#64748b',
			);
