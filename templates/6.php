...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url(CSMM_URL . 'templates/css/6.css'); ?>">
            ...
            <div class="home-slider">
                ...
                if (count($csmm_slide_ids)) {
                    foreach ($csmm_slide_ids['csmm-slide-id'] as $csmm_slide_key => $csmm_slide_value) {
                        ...
                        $csmm_slide_url = wp_get_attachment_image_src($csmm_slide_id, 'full', true); // attachment full slide URL
                ?>
                        <div class="home-slider-img" style="background-image: url(<?php echo esc_url($csmm_slide_url[0]); ?>);"></div>
                <?php
                    }
                } else {
                    echo '<div class="home-slider-img" style="background-image: url(' . esc_url(CSMM_URL . 'templates/images/temp-6-slides/1.webp') . ');"></div>';
                    echo '<div class="home-slider-img" style="background-image: url(' . esc_url(CSMM_URL . 'templates/images/temp-6-slides/2.webp') . ');"></div>';
                    echo '<div class="home-slider-img" style="background-image: url(' . esc_url(CSMM_URL . 'templates/images/temp-6-slides/3.webp') . ');"></div>';
                }
                ?>
            </div>
