...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo esc_url( CSMM_URL.'templates/css/26.css' ); ?>">
...
<body class="flex items-center justify-center min-h-screen">
    ...
    <main class="main-content container mx-auto px-4 text-center">
        ...
        <div class="w-full max-w-md mx-auto">
            <p class="mb-4 font-semibold text-gray-300"><?php echo ! empty( $csmm_form_headline ) ? esc_html( $csmm_form_headline ) : esc_html__( "Get notified at launch.", 'coming-soon-maintenance-mode' ); ?></p>
            <form id="subscribe-form" method="post" class="flex flex-col sm:flex-row gap-3">
				...
				<button type="submit" class="subscribe-btn py-3 px-6 rounded-md"><?php esc_html_e( "Request Access", 'coming-soon-maintenance-mode' ); ?></button>
            </form>
			
            <p id="success-message" class="mt-4 text-sm text-green-400 hidden"><?php esc_html_e( "Access granted. We'll be in touch.", 'coming-soon-maintenance-mode' ); ?></p>
			<?php
			$csmm_flag = 0;
    ...
    <script>
        ...
        class Particle {
            ...
            update() {
                ...
                // Mouse collision (repulsion effect)
            ...
            for (let a = 0; a < particlesArray.length; a++) {
                for (let b = a; b < particlesArray.length; b++) {
                    ...
                    if (distance < (canvas.width / 7) * (canvas.height / 7)) {
                        ...
                        ctx.strokeStyle = `rgba(52, 211, 153, ${opacityValue})`;
                        ctx.lineWidth = 1;
                        ctx.beginPath();
