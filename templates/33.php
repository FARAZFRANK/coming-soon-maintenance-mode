...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo esc_url( CSMM_URL.'templates/css/33.css' ); ?>">
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;700&family=Source+Serif+Pro:wght@700&display=swap" rel="stylesheet">
...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <main class="main-content container mx-auto text-center">
        ...
        <!-- Header -->
        <header class="mb-10">
            <h2 class="text-lg font-semibold tracking-widest uppercase text-gray-400 mb-2"><?php echo get_admin_name(); ?></h2>
            <h1 class="title-font text-5xl md:text-8xl text-white">
                <span class="reveal-text"><?php if($csmm_title != "") { echo esc_html( $csmm_title ); } ?></span>
            </h1>
        ...
        <!-- Countdown Timer -->
        <div id="countdown" class="grid grid-cols-4 gap-4 md:gap-8 mb-12 w-full max-w-lg mx-auto">
            <div>
        ...
        <div class="w-full max-w-md mx-auto mb-12">
            <p class="mb-4 font-semibold text-gray-300"><?php esc_html_e( "Get notified when I launch.", 'coming-soon-maintenance-mode' ); ?></p>
            <form id="subscribe-form" method="post" class="flex flex-col sm:flex-row gap-3">
                <input type="email" id="csmm-email" name="csmm-email" placeholder="Enter your email" class="subscribe-input flex-grow p-3 rounded-md focus:outline-none text-center" required>
            ...
            <p id="success-message" class="mt-4 text-sm text-green-400 hidden"><?php esc_html_e( "Thank you! I'll be in touch soon.", 'coming-soon-maintenance-mode' ); ?></p>
			<?php
			$csmm_flag = 0;
