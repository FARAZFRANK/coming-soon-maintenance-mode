...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo esc_url( CSMM_URL.'templates/css/34.css' ); ?>">
...
<body>
    ...
    <main class="split-layout">
        <!-- Left Side: Image (Reversed order for visual flow on mobile) -->
        <div class="image-side lg:order-2"></div>

        <!-- Right Side: Content -->
        <div class="content-side lg:order-1">
            <div class="w-full max-w-md mx-auto">
                ...
                <!-- Headline -->
                <h1 class="title-font text-4xl md:text-6xl font-bold leading-tight mb-4 text-gray-900 mt-1">
                ...
                <div class="w-full text-left">
                    <p class="mb-3 text-sm font-medium text-gray-700"><?php esc_html_e( "Join the VIP list for exclusive previews.", 'coming-soon-maintenance-mode' ); ?></p>
                    <form id="subscribe-form" method="post" class="flex flex-col sm:flex-row">
                        <input type="email" id="csmm-email" name="csmm-email" placeholder="Enter your email" class="subscribe-input w-full p-3 focus:outline-none rounded-l-md" required>
                        <input type="hidden" id="csmm-email-nonce" name="csmm-email-nonce" value="<?php echo esc_attr( wp_create_nonce( 'csmm-email-nonce' ) ); ?>">
						<button type="submit" class="subscribe-btn py-3 px-6 rounded-r-md"><?php esc_html_e( "Register", 'coming-soon-maintenance-mode' ); ?></button>
                    </form>
                    <p id="success-message" class="mt-3 text-sm text-green-700 hidden"><?php esc_html_e( "Thank you. We have received your registration.", 'coming-soon-maintenance-mode' ); ?></p>
					<?php
					$csmm_flag = 0;
