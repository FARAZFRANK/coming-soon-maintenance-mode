...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url(CSMM_URL . 'templates/css/12.css'); ?>">
...
<body>
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home page-hero target-section template-12" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width="3000" data-natural-height="2000" data-position-y="center">
        ...
        <div class="home-content">
            ...
            <div class="video-background">
                <video id="main-video" preload="auto" autoplay="autoplay" loop="loop" muted="muted" src="https://videos.pexels.com/video-files/7670835/7670835-uhd_2560_1440_30fps.mp4">
