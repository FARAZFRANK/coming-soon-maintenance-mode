...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo esc_url( CSMM_URL.'templates/css/36.css' ); ?>">
...
<body class="flex items-center justify-center min-h-screen p-4 md:p-8">
    ...
    <main class="postcard w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-lg overflow-hidden">
        <!-- Left Side: Image -->
        <div class="image-container overflow-hidden min-h-[50vh] lg:min-h-full">
            <img src="https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?q=80&w=1932&auto=format&fit=crop" alt="Beautiful coastal destination" class="w-full h-full object-cover">
        </div>
        <!-- Right Side: Content -->
        <div class="p-8 md:p-12 flex flex-col justify-center">
            ...
            <div class="w-full max-w-md">
				...
				<h1 class="title-font text-4xl md:text-6xl leading-tight mt-2">
					<?php if($csmm_title != "") { echo esc_html( $csmm_title ); } ?>
				</h1>
            </div>
            
            <!-- Generated Message -->
            <div id="postcard-message-container" class="min-h-[6rem] mb-8 mt-2">
                <p id="postcard-message" class="text-gray-600 leading-relaxed text-lg">
