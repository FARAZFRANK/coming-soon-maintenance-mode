...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( CSMM_URL.'templates/css/10.css' ); ?>">
    ...
    <main class="s-home s-home--static template-two">
        ...
        <div class="home-content s-home--slides">
			...
			<div class="row home-content__main">
				...
				<div class="cs-text-wrapper col-six text-center">
				...
				<div class="cs-image-wrapper col-six">
					<div class="img-wrap">
						<img src="<?php echo esc_url( CSMM_URL.'templates/images/temp-10-slides/frame.webp' ); ?>">
