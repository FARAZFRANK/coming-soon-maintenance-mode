...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( CSMM_URL.'templates/css/9.css' ); ?>">
...
<body>
    ...
    <video class="PhotoZoom_iframe__LeuQM" tabindex="-1" role="application" id="vjs_video_3_html5_api" class="vjs-tech" loop="" muted="muted" autoplay="" src="https://cdn.pixabay.com/video/2023/09/13/180386-864121573_large.mp4"></video>
    <!-- home
    ================================================== -->
    <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width="3000" data-natural-height="2000" data-position-y="center">
                ...
                <div class="home-content__subscribe">
                    <form id="mc-form" method="post" class="group">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if($csmm_flag == 1) {
                                echo ! empty( $csmm_form_success_msg ) ? esc_html( $csmm_form_success_msg ) : esc_html__( 'Thank you for subscribing!', 'coming-soon-maintenance-mode' );
                            } else {
                                echo ! empty( $csmm_form_already_subscribed_msg ) ? esc_html( $csmm_form_already_subscribed_msg ) : esc_html__( 'You are already subscribed.', 'coming-soon-maintenance-mode' );
                            }
                        }
                        ?>
                        </label>
		...
		<ul class="home-social">
			...
			<li><a href="<?php echo esc_url($csmm_sm_youtube); ?>" target="_blank"><i class="fa-brands fa-youtube" aria-hidden="true"><span>YouTube</span></i></a></li>
			<?php } ?>
			...
			<li><a href="<?php echo esc_url($csmm_sm_linkedin); ?>" target="_blank"><i class="fa-brands fa-linkedin-in" aria-hidden="true"><span>LinkedIn</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_pinterest) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_pinterest); ?>" target="_blank"><i class="fa-brands fa-pinterest" aria-hidden="true"><span>Pinterest</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_tumblr) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_tumblr); ?>" target="_blank"><i class="fa-brands fa-tumblr" aria-hidden="true"><span>Tumblr</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_snapchat) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_snapchat); ?>" target="_blank"><i class="fa-brands fa-snapchat" aria-hidden="true"><span>Snapchat</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_behance) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_behance); ?>" target="_blank"><i class="fa-brands fa-behance" aria-hidden="true"><span>Behance</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_dribbble) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_dribbble); ?>" target="_blank"><i class="fa-brands fa-dribbble" aria-hidden="true"><span>Dribbble</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_whatsapp) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_whatsapp); ?>" target="_blank"><i class="fa-brands fa-whatsapp" aria-hidden="true"><span>WhatsApp</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_tiktok) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_tiktok); ?>" target="_blank"><i class="fa-brands fa-tiktok" aria-hidden="true"><span>TikTok</span></i></a></li>
			<?php } ?>
			<?php if(empty($csmm_sm_qq) == false) { ?>
			<li><a href="<?php echo esc_url($csmm_sm_qq); ?>" target="_blank"><i class="fa-brands fa-qq" aria-hidden="true"><span>QQ</span></i></a></li>
			<?php } ?>
		</ul> <!-- end home-social -->
