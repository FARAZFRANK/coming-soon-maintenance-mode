            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="w-full text-left mb-10">
                    ...
                    <form id="subscribe-form" method="post" class="flex flex-col sm:flex-row gap-3">
						<input type="email" id="csmm-email" name="csmm-email" id="email-input" placeholder="<?php esc_attr_e( 'Your email address', 'coming-soon-maintenance-mode' ); ?>" class="subscribe-input flex-grow p-3 rounded-md focus:outline-none" required>
                        <input type="hidden" id="csmm-email-nonce" name="csmm-email-nonce" value="<?php echo esc_attr( wp_create_nonce( 'csmm-email-nonce' ) ); ?>">
						<button type="submit" class="subscribe-btn py-3 px-6 rounded-md"><?php esc_html_e( "Keep Me Posted", 'coming-soon-maintenance-mode' ); ?></button>
                    </form>
