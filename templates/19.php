    ...
    <main class="main-card w-full max-w-2xl text-center rounded-2xl p-8 m-4">
        ...
        <div class="w-full max-w-md mx-auto text-center mb-6">
            ...
            <form id="subscribe-form" method="post" class="flex flex-col sm:flex-row gap-3">
                <input type="email" id="csmm-email" name="csmm-email" placeholder="<?php esc_attr_e( 'Enter your email', 'coming-soon-maintenance-mode' ); ?>" class="subscribe-input flex-grow p-3 rounded-full focus:outline-none text-center" required>
                <input type="hidden" id="csmm-email-nonce" name="csmm-email-nonce" value="<?php echo esc_attr( wp_create_nonce( 'csmm-email-nonce' ) ); ?>">
				<button type="submit" class="subscribe-btn py-3 px-8 rounded-full"><?php esc_html_e( 'Get on the list', 'coming-soon-maintenance-mode' ); ?></button>
            </form>
